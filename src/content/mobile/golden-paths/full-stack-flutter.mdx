...
> **Stack:** Turborepo · Next.js 16 · Supabase · Flutter 3.32 · Riverpod · go_router

<Callout type="warning">
  This golden path is pending documentation by the Mobile capability lead. Contribute via a pull request.
</Callout>

...
> **Stack:** Next.js 16.1 · React 19.2 · Tailwind v4 · tRPC v11 · Prisma v7 · NextAuth v5 · Zustand v5

<Callout type="warning">
  This golden path is pending documentation by the Web capability lead. Contribute via a pull request.
</Callout>

...
> **Stack:** Fastify · TypeScript · Drizzle · OpenAPI · Zod

<Callout type="warning">
  This golden path is pending documentation by the Backend capability lead. Contribute via a pull request.
</Callout>

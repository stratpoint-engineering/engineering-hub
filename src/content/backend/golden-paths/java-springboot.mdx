...
<Callout type="info">
  The boilerplate for this golden path lives at [stratpoint-engineering/golden-paths](https://github.com/stratpoint-engineering/golden-paths/tree/main/backend/java-springboot).
</Callout>

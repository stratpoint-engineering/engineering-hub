...
> **Stack:** LlamaIndex · Python · RAG pipelines · document indexing

<Callout type="warning">
  This golden path is pending documentation by the AI/ML capability lead. Contribute via a pull request.
</Callout>
